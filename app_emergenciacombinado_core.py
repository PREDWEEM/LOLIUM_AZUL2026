...
# - OPTIMIZADOR 2D BIO-FÍSICO: Barrido sobre W_Max y cobertura (Ke derivado físicamente) optimizado para ventanas reales.
...
if logo_path.is_file():
    ...
    st.sidebar.caption("Motor predictivo Lolium — Azul")
